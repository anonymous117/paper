...
def define_all_titles():
    titles = []
    titles.append("Scaling all axes - P(512,80) - n=1x5")
    titles.append("Scaling all axes - P(512,80) - n=2x5")
    titles.append("Scaling all axes - P(512,80)) - n=3x5")
    titles.append("Scaling all axes - P(512,80) - n=4x5")
    titles.append("Scaling all axes - P(512,80) - n=5x5")
    titles.append("Scaling all axes - P(1024,90) - n=1x5")
    titles.append("Scaling all axes - P(1024,90) - n=2x5")
    titles.append("Scaling all axes - P(1024,90) - n=3x5")
    titles.append("Scaling all axes - P(1024,90) - n=4x5")
    titles.append("Scaling all axes - P(1024,90) - n=5x5")
    titles.append("Scaling for x-axis - P(512,10) - n=1x5")
    titles.append("Scaling for x-axis - P(512,10) - n=2x5")
    titles.append("Scaling for x-axis - P(512,10) - n=3x5")
    titles.append("Scaling for x-axis - P(512,10) - n=4x5")
    titles.append("Scaling for x-axis - P(512,10) - n=5x5")
    titles.append("Scaling for x-axis - P(1024,10) - n=1x5")
    titles.append("Scaling for x-axis - P(1024,10) - n=2x5")
    titles.append("Scaling for x-axis - P(1024,10) - n=3x5")
    titles.append("Scaling for x-axis - P(1024,10) - n=4x5")
    titles.append("Scaling for x-axis - P(1024,10) - n=5x5")
    titles.append("Scaling for y-axis - P(4,80) - n=1x5")
    titles.append("Scaling for y-axis - P(4,80) - n=2x5")
    titles.append("Scaling for y-axis - P(4,80) - n=3x5")
    titles.append("Scaling for y-axis - P(4,80) - n=4x5")
    titles.append("Scaling for y-axis - P(4,80) - n=5x5")
    titles.append("Scaling for y-axis - P(4,90) - n=1x5")
    titles.append("Scaling for y-axis - P(4,90) - n=2x5")
    titles.append("Scaling for y-axis - P(4,90) - n=3x5")
    titles.append("Scaling for y-axis - P(4,90) - n=4x5")
    titles.append("Scaling for y-axis - P(4,90) - n=5x5")
    return titles
