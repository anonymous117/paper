...
def define_all_titles():
    titles = []
    titles.append("Scaling all axes - P(256,70,14) - n=1x5")
    titles.append("Scaling all axes - P(256,70,14) - n=2x5")
    titles.append("Scaling all axes - P(256,70,14) - n=3x5")
    titles.append("Scaling all axes - P(256,70,14) - n=4x5")
    titles.append("Scaling all axes - P(256,70,14) - n=5x5")
    ...
    titles.append("Scaling for x-axis - P(256,10,2) - n=1x5")
    titles.append("Scaling for x-axis - P(256,10,2) - n=2x5")
    titles.append("Scaling for x-axis - P(256,10,2) - n=3x5")
    titles.append("Scaling for x-axis - P(256,10,2) - n=4x5")
    titles.append("Scaling for x-axis - P(256,10,2) - n=5x5")
    ...
    titles.append("Scaling for y-axis - P(4,70,2) - n=1x5")
    titles.append("Scaling for y-axis - P(4,70,2) - n=2x5")
    titles.append("Scaling for y-axis - P(4,70,2) - n=3x5")
    titles.append("Scaling for y-axis - P(4,70,2) - n=4x5")
    titles.append("Scaling for y-axis - P(4,70,2) - n=5x5")
    ...
    titles.append("Scaling for z-axis - P(4,10,14) - n=1x5")
    titles.append("Scaling for z-axis - P(4,10,14) - n=2x5")
    titles.append("Scaling for z-axis - P(4,10,14) - n=3x5")
    titles.append("Scaling for z-axis - P(4,10,14) - n=4x5")
    titles.append("Scaling for z-axis - P(4,10,14) - n=5x5")
