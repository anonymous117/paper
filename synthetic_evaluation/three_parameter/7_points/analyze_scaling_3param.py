...
if __name__ == "__main__":
    ...
    # for scaling along z-axis 1 step further
    P = 4
    S = 10
    N = 16
    results = []
    ...
    for i in range(len(results)):
        for j in range(len(results[i])):
            ...
            correct = 100 - incorrect
            results[i][j] = correct
    print("z-axis 1 step further:",results)
    data = "z-axis 1 step further:"+str(results)
    data_set.append(data)

    ###################################################################################################################################

    # for scaling along z-axis 2 step further
    P = 4
    S = 10
    N = 18
    results = []
    ...
    for i in range(len(results)):
        for j in range(len(results[i])):
            ...
            correct = 100 - incorrect
            results[i][j] = correct
    print("z-axis 2 step further:",results)
    data = "z-axis 2 step further:"+str(results)
    data_set.append(data)
