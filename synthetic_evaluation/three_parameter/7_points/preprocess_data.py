...
class experiment():
    def __init__(self, all_axis_1_data, all_axis_2_data, x_axis_1_data, x_axis_2_data, y_axis_1_data, y_axis_2_data, z_axis_1_data, z_axis_2_data):
        ...
        self.z_axis_1_data = z_axis_1_data
        self.z_axis_2_data = z_axis_2_data
        self.axes = []
        ...
        self.axes.append(self.z_axis_1_data)
        self.axes.append(self.z_axis_2_data)
...
def preprocess_data(data):
    ...
    for j in range(len(data)):
        ...
        for i in range(len(data_set)):
            ...
            axes.append(a)
        e = experiment(axes[0],axes[1],axes[2],axes[3],axes[4],axes[5],axes[6],axes[7])
...
def define_all_titles():
    titles = []
    titles.append("Scaling all axes - P(512,80,16) - n=1x5")
    titles.append("Scaling all axes - P(512,80,16) - n=2x5")
    titles.append("Scaling all axes - P(512,80,16) - n=3x5")
    titles.append("Scaling all axes - P(512,80,16) - n=4x5")
    titles.append("Scaling all axes - P(512,80,16) - n=5x5")
    titles.append("Scaling all axes - P(1024,90,18) - n=1x5")
    titles.append("Scaling all axes - P(1024,90,18) - n=2x5")
    titles.append("Scaling all axes - P(1024,90,18) - n=3x5")
    titles.append("Scaling all axes - P(1024,90,18) - n=4x5")
    titles.append("Scaling all axes - P(1024,90,18) - n=5x5")
    titles.append("Scaling for x-axis - P(512,10,2) - n=1x5")
    titles.append("Scaling for x-axis - P(512,10,2) - n=2x5")
    titles.append("Scaling for x-axis - P(512,10,2) - n=3x5")
    titles.append("Scaling for x-axis - P(512,10,2) - n=4x5")
    titles.append("Scaling for x-axis - P(512,10,2) - n=5x5")
    titles.append("Scaling for x-axis - P(1024,10,2) - n=1x5")
    titles.append("Scaling for x-axis - P(1024,10,2) - n=2x5")
    titles.append("Scaling for x-axis - P(1024,10,2) - n=3x5")
    titles.append("Scaling for x-axis - P(1024,10,2) - n=4x5")
    titles.append("Scaling for x-axis - P(1024,10,2) - n=5x5")
    titles.append("Scaling for y-axis - P(4,80,2) - n=1x5")
    titles.append("Scaling for y-axis - P(4,80,2) - n=2x5")
    titles.append("Scaling for y-axis - P(4,80,2) - n=3x5")
    titles.append("Scaling for y-axis - P(4,80,2) - n=4x5")
    titles.append("Scaling for y-axis - P(4,80,2) - n=5x5")
    titles.append("Scaling for y-axis - P(4,90,2) - n=1x5")
    titles.append("Scaling for y-axis - P(4,90,2) - n=2x5")
    titles.append("Scaling for y-axis - P(4,90,2) - n=3x5")
    titles.append("Scaling for y-axis - P(4,90,2) - n=4x5")
    titles.append("Scaling for y-axis - P(4,90,2) - n=5x5")
    titles.append("Scaling for z-axis - P(4,10,16) - n=1x5")
    titles.append("Scaling for z-axis - P(4,10,16) - n=2x5")
    titles.append("Scaling for z-axis - P(4,10,16) - n=3x5")
    titles.append("Scaling for z-axis - P(4,10,16) - n=4x5")
    titles.append("Scaling for z-axis - P(4,10,16) - n=5x5")
    titles.append("Scaling for z-axis - P(4,10,18) - n=1x5")
    titles.append("Scaling for z-axis - P(4,10,18) - n=2x5")
    titles.append("Scaling for z-axis - P(4,10,18) - n=3x5")
    titles.append("Scaling for z-axis - P(4,10,18) - n=4x5")
    titles.append("Scaling for z-axis - P(4,10,18) - n=5x5")
    return titles
