...
def define_all_titles():
    titles = []
    titles.append("Scaling for x-axis - P(128) - n=1x5")
    titles.append("Scaling for x-axis - P(128) - n=2x5")
    titles.append("Scaling for x-axis - P(128) - n=3x5")
    titles.append("Scaling for x-axis - P(128) - n=4x5")
    titles.append("Scaling for x-axis - P(128) - n=5x5")
    titles.append("Scaling for x-axis - P(256) - n=1x5")
    titles.append("Scaling for x-axis - P(256) - n=2x5")
    titles.append("Scaling for x-axis - P(256) - n=3x5")
    titles.append("Scaling for x-axis - P(256) - n=4x5")
    titles.append("Scaling for x-axis - P(256) - n=5x5")
    return titles
